...
namespace CustomValidation.Extensions
{
    public static class StringValidationExtensions
    {
        ...
        public static TBuilder HasMinLength<TBuilder>(this PropertyValidationBuilderBase<TBuilder, string> builder,
    int minLength)
        {
            if (minLength < 0)
            {
        ...
        public static TBuilder HasLengthBetween<TBuilder>(this PropertyValidationBuilderBase<TBuilder, string> builder,
